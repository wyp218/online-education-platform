	...
	<div class="list" :style='{"width":"calc(100% - 0px)","padding":"20px 0 0 0","margin":"0","background":"none","flex":"1","order":"6"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 0 0 5px","margin":"10px 0 0","overflow":"hidden","color":"#666","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"auto"}'>
			<div :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0","margin":"0 30px 30px 0","overflow":"hidden","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(25% - 30px)","position":"relative","justifyContent":"center","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<img @click.stop="imgPreView(item.zhaopian)" :style='{"border":"0px solid #eee","padding":"10px","margin":"0 0 10px","objectFit":"contain","background":"#f4f4f4","display":"block","width":"100%","height":"245px"}' v-if="item.zhaopian && item.zhaopian.substr(0,4)=='http'" :src="item.zhaopian.split(',')[0]" class="image" />
				<img @click.stop="imgPreView(baseUrl + (item.zhaopian?item.zhaopian.split(',')[0]:''))" :style='{"border":"0px solid #eee","padding":"10px","margin":"0 0 10px","objectFit":"contain","background":"#f4f4f4","display":"block","width":"100%","height":"245px"}' v-else :src="baseUrl + (item.zhaopian?item.zhaopian.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 0px","borderColor":"#ddd","margin":"0px","whiteSpace":"nowrap","color":"#5A5A5A","textAlign":"center","overflow":"hidden","borderWidth":"0 0 0px","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis","borderStyle":"solid"}' class="name ">{{item.jiaoshixingming}}</div>
