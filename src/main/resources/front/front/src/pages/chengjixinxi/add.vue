...
<div :style='{"minHeight":"500px","padding":"20px 20px 40px","margin":"0px auto","borderColor":"#ddd","background":"#fff","borderWidth":"0px","width":"1200px","position":"relative","borderStyle":"solid"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="作业成绩" prop="zuoyechengji">
			<el-input-number v-model="ruleForm.zuoyechengji" placeholder="作业成绩" :readonly="ro.zuoyechengji"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="批语" prop="piyu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="批语"
