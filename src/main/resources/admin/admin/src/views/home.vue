...
<div class="content" :style='{"padding":"30px"}'>
	...
	<div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'>
		...
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('kechengbaoming','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"rgba(44, 55, 66,1)","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-zhangjie18" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{kechengbaomingCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>课程报名总数</div>
			</div>
		</div>
		<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}' v-if="isAuth('zuoyexinxi','首页总数')">
			<div :style='{"width":"80px","alignItems":"center","background":"rgba(44, 55, 66,1)","justifyContent":"center","display":"flex","height":"80px"}'>
				<span class="icon iconfont icon-tongji7" :style='{"color":"#fff","fontSize":"24px"}'></span>
			</div>
			<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{zuoyexinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>作业信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="calendar" :style='{"boxShadow":"0 2px 8px rgba(0,0,0,.1)","margin":"30px auto","borderRadius":"16px","background":"#eaecf3","display":"block","width":"100%","height":"auth"}'>
	  <div :style='{"width":"100%","padding":"20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div @click="pyear" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一年</div>
	    <div @click="pmonth" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'><span class="icon iconfont icon-fanhui" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span>上一月</div>
	    <div :style='{"padding":"0 10px","alignItems":"center","justifyContent":"center","display":"flex"}'>
	      <div :style='{"color":"#333","margin":"0 2px","fontSize":"24px"}'>{{this.year}}年</div>
	      <div :style='{"color":"#333","margin":"0 2px","fontSize":"24px"}'>{{this.month}}月</div>
	    </div>
	    <div @click="nmonth" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一月<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	    <div @click="nyear" :style='{"cursor":"pointer","padding":"0 12px","alignItems":"center","color":"#fff","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","display":"flex","width":"auto","fontSize":"14px","justifyContent":"center","height":"40px"}'>下一年<span class="icon iconfont icon-jinru" :style='{"color":"#fff","margin":"0 2px","fontSize":"16px"}'></span></div>
	  </div>
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"10px 20px","flexWrap":"wrap","background":"rebeccapurple","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto"}'>
		<div id="xueshengChart1" class="echarts1" v-if="isAuth('xuesheng','首页统计')"></div>
		<div id="kechengbaomingChart1" class="echarts2" v-if="isAuth('kechengbaoming','首页统计')"></div>
		<div id="zuoyexinxiChart1" class="echarts3" v-if="isAuth('zuoyexinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
