  ...
  <div class="main-content" :style='{"padding":"30px"}'>
	...
	<div :style='{"width":"100%","padding":"10px"}'>
        ...
        >
          ...
          <el-table-column :resizable='false' :sortable='true' prop="name" header-align="center" align="center" sortable label="在线考试">
          ...
          >
            <template slot-scope="scope">
			  <el-button class="view" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"4px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(44, 55, 66, 0.9)","width":"auto","fontSize":"14px","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row.id)">
